    ...
    <div className="flex flex-col w-full bg-white shadow-md rounded-md p-4 items-center">
      ...
      <div className='flex flex-col items-center w-full h-full bg-white rounded-md mt-2 p-2 '>
                <div className='flex flex-wrap justify-center gap-2 h-full'>
                    ...
                    <p className='bg-blue-100 w-fit h-fit px-2 py-1 rounded-full text-[0.6rem] font-semibold shadow-md text-nowrap'>Business Sector: Transportation and Logistics</p>
                    <p className='bg-blue-100 w-fit h-fit px-2 py-1 rounded-full text-[0.6rem] font-semibold shadow-md text-nowrap'>Company: NAB NebulaWays Advisory Bureau</p>
                    <p className='bg-blue-100 w-fit h-fit px-2 py-1 rounded-full text-[0.6rem] font-semibold shadow-md text-nowrap'>Company Cluster: Cluster G</p>
                    <p className='bg-blue-100 w-fit h-fit px-2 py-1 rounded-full text-[0.6rem] font-semibold shadow-md text-nowrap'>Company Hierarchy: Regional Sales, Operations, Finance, Technology, HR</p>
                    <p className='bg-blue-100 w-fit h-fit px-2 py-1 rounded-full text-[0.6rem] font-semibold shadow-md text-nowrap'>Cost Center: Facilities-Security</p>
                    <p className='bg-blue-100 w-fit h-fit px-2 py-1 rounded-full text-[0.6rem] font-semibold shadow-md text-nowrap'>Department: Network Operations</p>
                    <p className='bg-blue-100 w-fit h-fit px-2 py-1 rounded-full text-[0.6rem] font-semibold shadow-md text-nowrap'>Email: byron.palmieri@agentnoon.com</p>
                    <p className='bg-blue-100 w-fit h-fit px-2 py-1 rounded-full text-[0.6rem] font-semibold shadow-md text-nowrap'>Employee Id: 22</p>
                    <p className='bg-blue-100 w-fit h-fit px-2 py-1 rounded-full text-[0.6rem] font-semibold shadow-md text-nowrap'>Employee Type: Apprentice External</p>
