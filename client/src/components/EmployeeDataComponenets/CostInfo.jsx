  ...
  return (
    <div id='costs' className='flex flex-col w-full h-fit bg-white shadow-lg rounded-md p-2'>
            ...
            <div className='w-full h-fit rounded-md flex flex-row p-2 justify-between'>
                ...
                <p className=' w-fit h-fit px-2 py-1 rounded-md text-[0.6rem] shadow-md font-semibold outline-dotted outline-2 outline-green-300'>{currentSelectedNode['Salary']}</p>
